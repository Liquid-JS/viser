...
var _viserCell = require('viser-cell');

var viser = _interopRequireWildcard(_viserCell);
...
var regSeries = ['pie', 'sector', 'line', 'smoothline', 'dashline', 'area', 'point', 'stackarea', 'smootharea', 'bar', 'stackbar', 'dodgebar', 'interval', 'stackinterval', 'dodgeinterval', 'schema', 'box', 'candle', 'polygon', 'path'];
var rootCharts = ['v-chart', 'v-lite-chart'];
var rootChartProps = ['data', 'scale'];
var seriesProps = ['position', 'quickType', 'gemo', 'adjust', 'color', 'shape', 'size', 'style', 'animate'];
